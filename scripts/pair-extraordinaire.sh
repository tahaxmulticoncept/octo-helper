...
PR_URL=$(gh pr create --title "Pair PR $TS" --body "Pair Extraordinaire via octo-helper")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for Pair Extraordinaire: https://github.com/tahaxmulticoncept?tab=achievements"
